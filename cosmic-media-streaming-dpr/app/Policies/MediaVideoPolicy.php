...
class MediaVideoPolicy
{
     ...
     * @return bool
     */
    public function view(User $user, MediaVideo $mediaVideo): bool
    {
     ...
     * @return bool
     */
    public function update(User $user, MediaVideo $mediaVideo): bool
    {
     ...
     * @return bool
     */
    public function delete(User $user, MediaVideo $mediaVideo): bool
    {
     ...
     * @return bool
     */
    public function forceDelete(User $user, MediaVideo $mediaVideo): bool
    {
     ...
     * @return bool
     */
    public function restore(User $user, MediaVideo $mediaVideo): bool
    {
     ...
     * @return bool
     */
    public function replicate(User $user, MediaVideo $mediaVideo): bool
    {
